...
while running:
    ...
    if click and "RACE_TRACK1" in game_state:
        ...
        #track
        pygame.draw.ellipse(screen,(100, 100, 100),      (8 - cam_x, 50 - cam_y, 300, 600))
        pygame.draw.rect(screen, (100,100,100),          (143 - cam_x, 50 - cam_y, 800, 100))
        pygame.draw.rect(screen, (100,100,100),          (143 - cam_x, 550-cam_y, 800, 100))
        pygame.draw.ellipse(screen,(100, 100, 100),      (795-3 - cam_x, 50 - cam_y, 300, 600))
        pygame.draw.rect(screen,(50,150,50),             (190-7 - cam_x, 150 - cam_y , 700, 400 ))
        #pygame.draw.ellipse(screen, (50, 150, 50), [150, 150, 800, 400])
        pygame.draw.rect(screen, (255, 255, 255), [400 - cam_x, 50 - cam_y, 40, 100])
    elif click and "RACE_TRACK2" in game_state:
        screen.fill((50, 150, 50))
        pygame.draw.ellipse(screen,(100, 100, 100), (50 - cam_x, 50 - cam_y, 1000, 600))
        pygame.draw.ellipse(screen, (50, 150, 50), [150-cam_x, 150 - cam_y, 800, 400])
        pygame.draw.rect(screen, (255, 255, 255), [500-cam_x, 50 - cam_y, 40, 100])
    ...
    screen_y = y - cam_y
    try:
        current_color = screen.get_at((int(screen_x + 21), int(screen_y)))
